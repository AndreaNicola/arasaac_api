...
class KeywordsApi {
  ...
  Future<Response<KeywordsResponse>> getAll({ 
    ...
    final _path = r'/keywords/{language}'.replaceAll('{' r'language' '}', encodeQueryParameter(_serializers, language, const FullType(Locales)).toString());
